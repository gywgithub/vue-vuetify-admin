<template>
  <div class="main">
    ...
    <video controls>
      <source src="/video/d3.webm" type="video/webm" />Sorry, your browser doesn't support embedded videos
    </video>
  </div>
</template>
<script lang="ts">
...
export default class ComponentTemplate extends Vue {
  ...
  private btnOnlineClick() {
    window.open('https://gywgithub.github.io/vue-d3-examples', '_blank')
  }
}
</script>
